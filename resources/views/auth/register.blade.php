    ...
    <div class="inside">
      {!! Form::open(['url' => '/register']) !!}
        ...
        <div class="input-group">
          ...
          {!! Form::text('lastname', null, ['class' => 'form-control', 'value' => "{{ old('lastname') }}"]) !!}
        </div>
        ...
        <div class="input-group">
          ...
          {!! Form::password('confirm-password', ['class' => 'form-control', 'value' => "{{ old('confirm-password') }}"]) !!}
        </div>
        {!! Form::submit('Registrarse', ['class' => 'btn btn-success btn-100 mt-16']) !!}
      {!! Form::close() !!}
      @include('components.alert')
      <div class="footer mt-16 justify-content-center">
